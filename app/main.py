...
def generate_cv_fr(cv_data):
  ...
  prompt = f"Mon nom est {name}. J'ai {experience} d'experience en {skills}. Je suis dipomé en {education}. Peux-tu générer un CV."
...
def generate_new_cv(gen_cv, assistant):
  ...
  run = client.beta.threads.runs.create_and_poll(
    ...
    instructions = "Pourrais-tu améliorer le CV et fournir les élements manquants et rendre le résultat au format JSON sans ajouter de commentaires. "
  )
